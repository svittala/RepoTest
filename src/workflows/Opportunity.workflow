...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>PriceBook_Update_EMEA</fullName>
        <field>SBQQ__QuotePricebookId__c</field>
        <formula>$Label.Price_Book_EMEA</formula>
        <name>PriceBook Update EMEA</name>
    ...
    <rules>
        <fullName>SBU and Company Code Opp EMEA</fullName>
        <actions>
            <name>PriceBook_Update_EMEA</name>
        ...
        <criteriaItems>
            ...
            <value>MP - EMEA,RP - EMEA,EAS - EMEA</value>
        </criteriaItems>
